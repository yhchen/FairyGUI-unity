namespace FairyGUI
{
    public partial class Stage
    {
        ...
        public void OpenKeyboard(string text, int keyboardType, bool autocorrection, bool multiline, bool secure, bool alert, bool hideInput, string textPlaceholder, int characterLimit)
        {
            if (_keyboard != null)
            {
